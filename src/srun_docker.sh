...
Usage: $(basename $0) [-h|--help]
    ...
    Typical usage examples:
        ...
        srun ./srun_docker.sh --script=./hvd_example_script.sh \\
            --container="nvcr.io/nvidian_sas/avolkov:tf1.7rc0py2_cuda9.1_cudnn7_nccl2.1.15_hvd_ompi3_ibverbs"
...
function launch_dock_sess() {
    ...
    run_dock_asuser.sh --dockname=${dockname} ${privilegedopt} --net=host \
        --datamnts="${datamnts}" \
        --envlist=sshconfigdir,sshdport,hostlist,scriptpath,remainargs,np \
